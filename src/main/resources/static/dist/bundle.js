...
/***/ (function(module, exports, __webpack_require__) {
	...
	const SuggestedAddress = React.createClass({ displayName: "SuggestedAddress",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(2);
	const ReactDOM = __webpack_require__(160);
	const $ = __webpack_require__(161);

	const test = document.getElementById('test');

	const SuggestedAddress = __webpack_require__(1);
	...
	const App = React.createClass({ displayName: "App",
	    ...
	    addressSuggestion: function (event) {
	...
	ReactDOM.render(React.createElement(App, null), test);
